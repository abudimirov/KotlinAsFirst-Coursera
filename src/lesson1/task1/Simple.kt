 ...
 */
/** 1сек = 0.000484813 рад*/
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = ((deg * 3600 + min * 60 + sec) * 0.000484813) / 100
...
fun accountInThreeYears(initial: Int, percent: Int): Double {
    ...
    val firstYearBalance = initialDouble / percent + initialDouble
    val secondYearBalance = ((initialDouble / percent + initialDouble) / percent) + firstYearBalance
    val thirdYearBalance = secondYearBalance / percent + secondYearBalance
    return thirdYearBalance
    /**На выходе получаем бесконечность.... Почему...??? */
}
